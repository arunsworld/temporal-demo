...
{{- define "temporal-demo.componentname" -}}
{{- $global := index . 0 -}}
{{- $component := index . 1 | trimPrefix "-" -}}
{{- printf "%s-%s" (include "helm-charts.fullname" $global | trunc (sub 62 (len $component) | int) | trimSuffix "-" ) $component | trimSuffix "-" -}}
{{- end }}


{{- define "temporal-demo.customer.port" -}}
9399
{{- end}}

{{- define "temporal-demo.clearing-house.port" -}}
{{- end}}

{{- define "temporal-demo.money-laundering.port" -}}
9999
{{- end}}

{{- define "temporal-demo.abbank.port" -}}
{{- end}}

{{- define "temporal-demo.bcbank.port" -}}
{{- end}}
